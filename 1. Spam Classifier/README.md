...
## Understanding Data
The collection is composed by just one text file. So, I create two columns "Label" and "Message".Where "Message" is independent column and "Label" is dependent as per data.
...
I prepare data in following steps:
First-	
